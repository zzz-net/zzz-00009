...
from asset_retag.state import StateManager, StateError
from asset_retag.parser import ConfigParser
...
"""
    ...
    # 验证没有留下新的状态文件（应该被清理了）
    print(f"新建状态文件: {len(new_state)} (预期: 0 或已被清理)")
    print(f"新建日志文件: {len(new_log)} (预期: 0 或已被清理)")
